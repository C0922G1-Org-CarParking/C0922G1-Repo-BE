...
public class ParkingNewsRestController_getDetailParkingNews {
    ...
    public void getDetailParkingNews_parkingNewsId_1() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/public/parking_news/detail/{parkingNewsId}", "null"))
                .andDo(print())
    ...
    public void getDetailParkingNews_parkingNewsId_2() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/public/parking_news/detail/{parkingNewsId}", ""))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    ...
    public void getDetailParkingNews_parkingNewsId_3() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/public/parking_news/detail/{parkingNewsId}", notExistedParkingNewsId))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
    ...
    /**Created by: QuynhND
     * Date created: 29/03/2023
     * Test for id exists in database, id = 3;
     * @throws Exception
     */
    @Test
    public void getDetailParkingNews_parkingNewsId_4() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/public/parking_news/detail/{parkingNewsId}", "3"))
                .andDo(print())
