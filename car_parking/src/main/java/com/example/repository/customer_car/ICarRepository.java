...
public interface ICarRepository extends JpaRepository<Car, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "update car set  car.is_deleted = true where car.customer_id=:id", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "select * from car where car.customer_id = :id ", nativeQuery = true)
